...
impl std::fmt::Display for SevError {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        ...
        match self {
            SevError::InvalidPlatformState => write!(f,"Invalid platform state. Status Code: {code}"),
            SevError::InvalidGuestState => write!(f,"Invalid guest state. Status Code: {code}"),
            SevError::InvalidConfig => write!(f,"Platform configuration invalid. Status Code: {code}"),
            SevError::InvalidLen => write!(f,"Memory buffer too small. Status Code: {code}"),
            SevError::AlreadyOwned => write!(f,"Platform is already owned. Status Code: {code}"),
            SevError::InvalidCertificate => write!(f,"Invalid certificate. Status Code: {code}"),
            SevError::PolicyFailure => write!(f,"Policy failure. Status Code: {code}"),
            SevError::Inactive => write!(f,"Guest is inactive. Status Code: {code}"),
            SevError::InvalidAddress => write!(f,"Provided address is invalid. Status Code: {code}"),
            SevError::BadSignature => write!(f,"Provided signature is invalid. Status Code: {code}"),
            SevError::BadMeasurement => write!(f,"Provided measurement is invalid. Status Code: {code}"),
            SevError::AsidOwned => write!(f,"ASID is already owned. Status Code: {code}"),
            SevError::InvalidAsid => write!(f,"ASID is invalid. Status Code: {code}"),
            SevError::WbinvdRequired => write!(f,"WBINVD instruction required. Status Code: {code}"),
            SevError::DfFlushRequired => write!(f,"DF_FLUSH invocation required. Status Code: {code}"),
            SevError::InvalidGuest => write!(f,"Guest handle is invalid. Status Code: {code}"),
            SevError::InvalidCommand => write!(f,"Issued command is invalid. Status Code: {code}"),
            SevError::Active => write!(f,"Guest is active. Status Code: {code}"),
            SevError::HardwarePlatform => {
                write!(f,"Hardware condition occured, safe to re-allocate parameter buffers. Status Code: {code}")
            }
            SevError::HardwareUnsafe => {
                write!(f,"Hardware condition occured, unsafe to re-allocate parameter buffers. Status Code: {code}")
            }
            SevError::Unsupported => write!(f,"Feature is unsupported. Status Code: {code}"),
            SevError::InvalidParam => write!(f,"Given parameter is invalid. Status Code: {code}"),
            SevError::ResourceLimit => {
                write!(f,"SEV firmware has run out of required resources to carry out command. Status Code: {code}")
            }
            SevError::SecureDataInvalid => write!(f,"SEV platform observed a failed integrity check. Status Code: {code}"),
            SevError::InvalidPageSize => write!(f,"The RMP page size is incorrect. Status Code: {code}"),
            SevError::InvalidPageState => write!(f,"The RMP page state is incorrect. Status Code: {code}"),
            SevError::InvalidMdataEntry => write!(f,"The metadata entry is invalid. Status Code: {code}"),
            SevError::InvalidPageOwner => write!(f,"The page ownership is incorrect. Status Code: {code}"),
            SevError::AEADOFlow => write!(f,"The AEAD algorithm would have overflowed. Status Code: {code}"),
            SevError::RbModeExited => write!(f,"A Mailbox mode command was sent while the SEV FW was in Ring Buffer \
                                    mode. Ring Buffer mode has been exited; the Mailbox mode command has \
                                    been ignored. Retry is recommended. Status Code: {code}"),
            SevError::RMPInitRequired => write!(f,"The RMP must be reinitialized. Status Code: {code}"),
            SevError::BadSvn => write!(f,"SVN of provided image is lower than the committed SVN. Status Code: {code}"),
            SevError::BadVersion => write!(f,"Firmware version anti-rollback. Status Code: {code}"),
            SevError::ShutdownRequired => write!(f,"An invocation of SNP_SHUTDOWN is required to complete this action. Status Code: {code}"),
            SevError::UpdateFailed => write!(f,"Update of the firmware internal state or a guest context page has failed. Status Code: {code}"),
            SevError::RestoreRequired => write!(f,"Installation of the committed firmware image required. Status Code: {code}"),
            SevError::RMPInitFailed => write!(f,"The RMP initialization failed. Status Code: {code}"),
            SevError::InvalidKey => write!(f,"The key requested is invalid, not present, or not allowed. Status Code: {code}"),
